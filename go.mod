...
replace github.com/data-preservation-programs/go-synapse => ../go-synapse
...
require (
	...
	github.com/data-preservation-programs/go-synapse v0.0.0-20260310124115-0faeb6924d36 // indirect
